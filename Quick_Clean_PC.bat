...
DEL /S /Q /F "%USERPROFILE%\Local Settings\Temp\*.*">nul
DEL /S /Q /F "%LOCALAPPDATA%\Temp\*.*">nul
...
:----------------
REM echo Running Malwarebytes fullscan
REM $mbam_source = "C:\Program Files (x86)\Malwarebytes' Anti-Malware\mbam.exe"
REM RunWait($mbam_source & " /runupdate")
REM RunWait($mbam_source & " /fullauto")
